package com.ericsson.iot.rms.grpc.client;
...
/**
 * Unit tests for {@link HelloWorldClient}. For demonstrating how to write gRPC
...
public class HelloWorldClientTest {
	...
	private final GreeterGrpc.GreeterImplBase serviceImpl = mock(GreeterGrpc.GreeterImplBase.class,
			delegatesTo(new GreeterGrpc.GreeterImplBase() {
			}));
